...
import { useDepositSdexVault } from 'hooks/useSdexVaultFacet'
...
interface DepositVaultFormProps {
  usersValidNFTs: object[]
  farmid: string
}

const DepositSdexVaultForm: FC<DepositVaultFormProps> = ({usersValidNFTs, farmid}) => {
  ...
  return (
    ...
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">Deposit Vault</h5>
        <p>
          The Sdex Vault autocompounds your stake on your behalf
        </p>
...
export default DepositSdexVaultForm
