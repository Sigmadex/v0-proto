...
import { AppStorage, LibAppStorage, Modifiers, PoolInfo, UserInfo, UserPosition, REWARDPOOL } from '../../libraries/LibAppStorage.sol';
...
/**
  * @title MultiplierFAcet
  * @dev The {MultiplierFacet}  implements the custom reward,withdraw, vaultWithdraw logic for the {MultiplierReward} NFT.    
*/
contract MultiplierFacet is  Modifiers {
//  constructor() {
//  }
//  /**
...
//  */
//  function mAddress() public returns (address) {
...
//  */
//  function mReductionAmount(uint256 id) external returns (RPAmount memory) {
//    AppStorage storage s = LibAppStorage.diamondStorage();
...
//  */
//  function mWithdraw(uint256 pid, uint256 positionid) public  {
//    AppStorage storage s = LibAppStorage.diamondStorage();
...
//  */
//  function mWithdrawVault(uint256 positionid) external  {
//    AppStorage storage s = LibAppStorage.diamondStorage();
